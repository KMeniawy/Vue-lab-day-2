...
<form class="well form-horizontal col-md-6" action=" " method="post"  id="contact_form" @submit.prevent="createUser">


<!-- Form Name -->
<legend class="my-4"><center><h2><b>Registration Form</b></h2></center></legend><br>
